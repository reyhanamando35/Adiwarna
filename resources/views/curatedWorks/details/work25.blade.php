...
<div>
    ...
    <h1 class=" w-full sm:w-[80%] sm:mt-10 lg:mt-20 maragsa text-[#A14000] font-bold text-[22px] sm:text-[35px] lg:text-[45px] leading-none">Perancangan Strategi Promosi Parfum Hyangee Melalui Media Sosial Untuk Membangun Brand Awareness dan Identitas Visual</h1>
    ...
    <div class=" sm:mt-24 lg:mt-36 flex flex-col lg:flex-row-reverse gap-10 sm:gap-[20rem] lg:gap-36 items-center">
        ...
        <!-- text -->
        <div class="w-4/5">
            <h1 class="maragsa text-[#67753E] text-[28px] sm:text-[35px] lg:text-[45px]">Eleonora Audrey Winarko</h1>
            <h1 class="maragsa text-[#67753E] text-[18px] sm:text-[25px] lg:text-[35px] mt-2 lg:mt-5">E12210060 - Brand & Product Innovation</h1>
            <p class="mt-10 lg:mt-5 text-[15px] lg:text-[20px]">
                Hyangee adalah merek parfum balm berbahan dasar minyak esensial yang ditujukan bagi perempuan muda dengan gaya hidup aktif. Menggunakan bentuk gantungan kunci yang praktis, produk ini menawarkan solusi wewangian yang ringkas dan mudah dibawa ke mana saja. Sebagai merek dan konsep yang baru, Hyangee membutuhkan perancangan komunikasi visual yang mampu membangun citra sekaligus menarik perhatian target audiens. Karya ini mencakup pengembangan identitas visual merek Hyangee, meliputi logo, warna, tipografi, dan gaya desain yang merepresentasikan karakter produk. Selain itu, perencanaan strategi komunikasi digital melalui media sosial Instagram dan TikTok digunakan untuk memperkuat brand awareness dengan pendekatan visual yang ringan, informatif, dan relevan dengan tren pasar. 
            </p>
            <div id="more-info" class="hidden">
                <p class="mt-5 text-[15px] lg:text-[20px]">
                    Karya ini juga dilengkapi dengan desain media pendukung seperti tampilan Shopee store, kemasan produk, serta media merchandise sebagai bentuk perluasan komunikasi merek. Seluruh elemen dirancang  untuk menciptakan citra merek yang kuat, menarik, dan mudah dikenali oleh target audiens.
                </p>
            </div>
    ...
    <div id="artwork" class="relative mx-auto sm:mt-[5rem] lg:mt-[10rem] max-w-[90vw] sm:max-w-[640px] md:max-w-[768px] lg:max-w-[900px]">
        <div id="artwork-viewport" class="overflow-x-auto snap-x snap-mandatory scroll-smooth">
            <div id="carousel-track" class="flex gap-6">
                ...
                <img src="{{ asset('asset/images/curated/curated25/curated_b.png') }}" class="shrink-0 max-h-[400px] w-auto h-auto object-contain shadow-md snap-center">
                <img src="{{ asset('asset/images/curated/curated25/curated_c.png') }}" class="shrink-0 max-h-[400px] w-auto h-auto object-contain shadow-md snap-center">
                <img src="{{ asset('asset/images/curated/curated25/curated_d.png') }}" class="shrink-0 max-h-[400px] w-auto h-auto object-contain shadow-md snap-center">
                <img src="{{ asset('asset/images/curated/curated25/curated_e.png ') }}" class="shrink-0 max-h-[400px] w-auto h-auto object-contain shadow-md snap-center">
            </div>
        </div>
    </div>
