...
<div>
    ...
    <h1 class=" w-full sm:w-[80%] sm:mt-10 lg:mt-20 maragsa text-[#A14000] font-bold text-[22px] sm:text-[35px] lg:text-[45px] leading-none">Analisis Visual Karakter Sebagai Media Pendidikan dan Pembangunan Karakter Generasi Z : Studi Kasus Howl's Moving Castle Produksi Studio Ghibli</h1>
