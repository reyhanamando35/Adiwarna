            ...
            <div id="contentContainer" class="w-[55%] flex flex-col justify-center items-center">
                <div class="w-full flex flex-col justify-center items-center">
                    <div id="title" class="w-full flex flex-col justify-center items-start">
                        <h1 id="titleFirst" class="font-maragsa text-[var(--red)]">Ruang Cerita :</h1>
                        <h1 id="titleSecond" class="font-maragsa text-[var(--red)]">Berkarir di Balik Lensa</h1>
                    </div>
                ...
                <div style="width: 100%;" class="flex flex-col justify-center items-center">
                    <div id="waktuTempat" class="w-full flex flex-col justify-center items-start ">
                        ...
                        <h1 id="date" class="font-sen text-[var(--light-green)]">21 Agustus 2025</h1>
                        <h1 id="time" class="font-sen text-[var(--light-green)]">16.00 - 18.00 WIB</h1>
                    </div>
                    <div id="registCont" style="width: 100%;" class="flex justify-center items-center">
                        <div id="registHere" onclick="window.open('http://petra.id/RegistrationTSRuangCerita', '_blank')"
